...
const carouselData = [
  {
    id: 1,
    text: 'Science has shown that healthy habits, meditation, and social connection create well-being.',
  },
  { id: 2, image: require('../../assets/images/user1.png') },
  { id: 3, image: require('../../assets/images/user2.png') },
];
